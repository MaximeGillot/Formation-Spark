 ...
 */
public class SparkStreamKafkaEventTimeAggregations {
    public static void main(String[] args) throws StreamingQueryException, TimeoutException {
        ...
        Dataset<Row> parsedData =
                rawData
                        .withColumn("json", rawData.col("value").cast("string")) // cast du binaire en string
                        ...
                        .groupBy(new Column("topic"), functions.window(new Column("timestamp"), "1 minute"))
                        .count();
